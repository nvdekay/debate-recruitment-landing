...
const Committees = () => {
    ...
    const committees = [
        {
            ...
            description: "Ban Nội Dung là linh hồn của giải đấu. Chúng tôi chịu trách nhiệm nghiên cứu sâu rộng, soạn thảo các chủ đề tranh biện phức tạp, thiết lập hệ thống quy tắc công bằng, và cung cấp các tài liệu giáo dục cần thiết. Ban Nội Dung đảm bảo Debate Prophecy không chỉ là một cuộc thi, mà là một hành trình thách thức tư duy đỉnh cao.",
            color: "from-purple-500 to-indigo-600"
        },
        {
            name: "HẬU CẦN",
            icon: <FaTools className="text-7xl text-orange-400 drop-shadow-glow" />,
            description: "Ban Hậu Cần đóng vai trò là người giữ lửa cho sự kiện. Mọi hoạt động từ việc chuẩn bị địa điểm, quản lý thiết bị kỹ thuật, điều phối lịch trình, đến việc đảm bảo mọi nguồn cung cấp đều sẵn sàng đều do chúng tôi phụ trách. Chúng tôi tạo ra một môi trường hoạt động liền mạch và hiệu quả, hỗ trợ tối đa cho các ban khác.",
            color: "from-red-500 to-orange-600"
        },
        {
            name: "TAKE CARE",
            icon: <FaHandsHelping className="text-7xl text-pink-400 drop-shadow-glow" />,
            description: "Ban Takecare là sứ giả của sự ấm áp. Nhiệm vụ chính là đảm bảo phúc lợi toàn diện cho tất cả thí sinh và khách mời. Từ dịch vụ khách sạn, sắp xếp chỗ ăn ở, đến việc hỗ trợ tinh thần và giải quyết các vấn đề cá nhân, chúng tôi cam kết mang lại một trải nghiệm thoải mái, chu đáo và đáng nhớ nhất cho mọi người tham gia.",
            color: "from-pink-500 to-rose-600"
        },
        {
            name: "ĐỐI NGOẠI",
            icon: <FaHandshake className="text-7xl text-cyan-400 drop-shadow-glow" />,
            description: "Ban Đối Ngoại là cầu nối vươn xa của giải đấu. Chúng tôi xây dựng và duy trì mối quan hệ chiến lược với các nhà tài trợ, đối tác truyền thông và các tổ chức bên ngoài. Chúng tôi mở rộng mạng lưới ảnh hưởng, đảm bảo nguồn lực dồi dào và nâng cao vị thế của Debate Prophecy trên bản đồ các sự kiện học thuật.",
            color: "from-blue-500 to-cyan-600"
        },
        {
            name: "TRUYỀN THÔNG",
            icon: <FaBullhorn className="text-7xl text-yellow-400 drop-shadow-glow" />,
            description: "Ban Truyền Thông là tiếng nói của giải đấu. Chúng tôi quản lý toàn bộ chiến lược quảng bá, nội dung mạng xã hội và các chiến dịch digital. Mục tiêu của chúng tôi là lan tỏa thông điệp của Debate Prophecy, thu hút sự chú ý của công chúng và đảm bảo mọi diễn biến quan trọng của cuộc thi được đưa tin rộng rãi và kịp thời.",
            color: "from-yellow-500 to-amber-600"
        },
        {
            name: "DESIGN",
            icon: <FaPaintBrush className="text-7xl text-fuchsia-400 drop-shadow-glow" />,
            description: "Ban Design là nghệ sĩ thị giác của sự kiện. Chúng tôi chịu trách nhiệm tạo ra tất cả các ấn phẩm truyền thông, nhận diện thương hiệu, và tài liệu quảng cáo. Với sự sáng tạo không giới hạn, chúng tôi biến mọi ý tưởng thành hình ảnh độc đáo, thống nhất và gây ấn tượng mạnh mẽ với công chúng.",
            color: "from-fuchsia-500 to-purple-600"
        },
        {
            name: "MEDIA",
            icon: <FaCameraRetro className="text-7xl text-emerald-400 drop-shadow-glow" />,
            description: "Ban Media là người ghi lại khoảnh khắc lịch sử. Chúng tôi sản xuất, quay phim, chụp ảnh và chỉnh sửa toàn bộ nội dung đa phương tiện trong suốt sự kiện. Từ các video highlight kịch tính đến những bức ảnh chân thực, chúng tôi lưu giữ mọi cảm xúc và cột mốc quan trọng của Debate Prophecy một cách chuyên nghiệp và sắc nét.",
            color: "from-emerald-500 to-teal-600"
        },
        {
            name: "TÀI CHÍNH",
            icon: <FaMoneyBillWave className="text-7xl text-lime-400 drop-shadow-glow" />,
            description: "Ban Tài Chính là người quản lý nguồn lực của giải đấu. Chúng tôi đảm bảo mọi chi phí được sử dụng hiệu quả, lập kế hoạch ngân sách chi tiết và tối ưu hóa các nguồn thu. Ban Tài Chính là trụ cột giữ cho toàn bộ hành trình hoạt động bền vững và hiệu quả lâu dài.",
    ...
    const CardFront = ({ committee, index, isFlipped }) => (
        <motion.div
            ...
            animate={{
                borderColor: isFlipped ? "rgba(168,85,247,0.3)" : [
                    "rgba(168,85,247,0.3)",
                    "rgba(236,72,153,0.5)",
                    "rgba(253,224,71,0.5)",
                    "rgba(168,85,247,0.3)"
                ],
                boxShadow: isFlipped ? "0 0 25px rgba(168,85,247,0.3)" : [
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                {[...Array(10)].map((_, i) => (
                    <motion.div
                        ...
                        style={{
                            background: `radial-gradient(circle, ${i % 3 === 0 ? 'rgba(168,85,247,0.1)' : i % 3 === 1 ? 'rgba(236,72,153,0.1)' : 'rgba(253,224,71,0.1)'} 0%, transparent 70%)`,
                            left: `${Math.random() * 100}%`,
                            top: `${Math.random() * 100}%`,
                        }}
                        animate={{
