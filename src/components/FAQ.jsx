        ...
        >
          <h2
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold mb-4 font-unbounded 
                       ...
                       bg-clip-text text-transparent drop-shadow-[0_0_25px_rgba(255,80,80,0.5)] pt-3"
          >
          ...
          {faqData.map((item, index) => (
            <motion.div
              ...
              whileHover={{
                scale: 1.01,
                zIndex: 10,
                boxShadow: "0 0 35px rgba(255, 105, 180, 0.4)",
              }}
            >
              <div
                className="bg-gray-900/80 rounded-2xl overflow-hidden backdrop-blur-sm shadow-xl 
